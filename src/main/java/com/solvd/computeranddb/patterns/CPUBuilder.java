...
public class CPUBuilder {
    ...
    public CPUBuilder withModel(String model) {
        this.model = model;

        return this;
    }

    public CPUBuilder withNumberOfCores(int numberOfCores) {
        this.numberOfCores = numberOfCores;

        return this;
    }

    public CPUBuilder withClockRateInGHz(double clockRateInGHz) {
        this.clockRateInGHz = clockRateInGHz;

        return this;
    }

    public CPUBuilder withTurboBoost(boolean hasTurboBoost) {
        this.hasTurboBoost = hasTurboBoost;

        return this;
    }

    public CPUBuilder withComputerId(int computerId) {
